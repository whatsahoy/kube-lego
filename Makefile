...
codegen:
	which mockgen
	mockgen -imports .=github.com/whatsahoy/kube-lego/pkg/kubelego_const -package=mocks -source=pkg/kubelego_const/interfaces.go > pkg/mocks/mocks.go
